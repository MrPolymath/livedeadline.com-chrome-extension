...
var Options = function Options() {
  ...
  // Update form values when loading the page to match settings
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (settings.countdownEndTime) {
      var date = new Date(settings.countdownEndTime);
      ...
      setTime("".concat(hours, ":").concat(minutes));
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("835469ee4c34cf5607a9")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=options.3b87d7e41aead19bce21.hot-update.js.map